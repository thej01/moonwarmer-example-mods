...
// you can check for any moonwarmer script, but i chose this one
// check if moonwarmer exists
if asset_get_index("moonwarmer_version") != noone
{
    // Use the api to see if the shader example exists from ID
    if moonwarmer_mod_exists("github.shaderexample.thej01")
    {
