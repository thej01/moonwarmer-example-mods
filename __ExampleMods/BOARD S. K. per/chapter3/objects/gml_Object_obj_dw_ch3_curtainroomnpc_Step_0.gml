if (init == 0)
{
    var skip_machine = instance_create(1800, 159, obj_npc_room);
    skip_machine.sprite_index = spr_tv_skip_vending;
    ...
    save_point = instance_create(pippins_marker.x + 110, 230, obj_savepoint);
