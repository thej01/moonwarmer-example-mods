function scr_text(arg0)
{
    switch (arg0)
    {
        ...
        case 4268:
            global.choice = -1;
            global.choicemsg[0] = stringsetloc("#Skip", "scr_text_slash_scr_text_gml_7980_0");
            global.choicemsg[1] = stringsetloc("#Refuse", "scr_text_slash_scr_text_gml_7980_0");
            global.choicemsg[2] = stringset("");
            global.choicemsg[3] = stringset("");
            scr_speaker("no_name");
            msgsetloc(0, "* BOARD S. K. per!/", "scr_text_slash_scr_text_gml_7985_0");
            msgnextloc("* Ever wanted to skip those Lovingly-crafted boards? Well, now you can!/", "scr_text_slash_scr_text_gml_7985_0");
            msgnextloc("* You will also receive a 1500 point bonus for partnering up with us!/", "scr_text_slash_scr_text_gml_7985_0");
            msgnextloc("* Warning: Side effects include skipping a lot of content and migraines./", "scr_text_slash_scr_text_gml_7985_0");
            msgnextloc("* (Use the machine?)/", "scr_text_slash_scr_text_gml_7985_0");
            msgnext("\\C2");
        ...
        case 4270:
            ...
            if (global.plot >= 280)
            {
                msgsetloc(0, "* (It's broken)/", "scr_text_slash_scr_text_gml_7985_0");
            }
            else
            {
                msgsetloc(0, "* BOARD S. K. per!/", "scr_text_slash_scr_text_gml_7985_0");
