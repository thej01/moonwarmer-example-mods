...
if (global.menuno == 5)
{
    ...
    if ((global.submenu >= 30 && global.submenu <= 33) || global.submenu == 36)
    {
        ...
        draw_set_color(c_white);
        draw_text(xx + 270, yy + 95, string_hash_to_newline(stringsetloc("CONFIG", "obj_darkcontroller_slash_Draw_0_gml_74_0")));
        ...
        draw_text(_xPos, yy + 120, string_hash_to_newline(stringsetloc("Master Volume", "obj_darkcontroller_slash_Draw_0_gml_86_0")));
        draw_text(_selectXPos, yy + 120, string_hash_to_newline(audvol));
        draw_set_color(c_white);
        draw_text(_xPos, yy + 155, string_hash_to_newline(stringsetloc("Controls", "obj_darkcontroller_slash_Draw_0_gml_91_0")));
        draw_text(_xPos, yy + 190, string_hash_to_newline(stringsetloc("Simplify VFX", "obj_darkcontroller_slash_Draw_0_gml_92_0")));
        ...
        {
            draw_text(_xPos, yy + 225, string_hash_to_newline(stringsetloc("Fullscreen", "obj_darkcontroller_slash_Draw_0_gml_93_0")));
            draw_text(xx + 430, yy + 225, string_hash_to_newline(fullscreenoff));
            draw_text(_xPos, yy + 260, string_hash_to_newline(autorun_text));
            ...
            draw_text(_xPos, yy + 330, string_hash_to_newline(stringsetloc("Return to Title", "obj_darkcontroller_slash_Draw_0_gml_95_0")));
            draw_text(_xPos, yy + 365, string_hash_to_newline(back_text));
        }
    }
