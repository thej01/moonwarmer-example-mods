...
if (global.menuno == 5)
{
    ...
    if ((global.submenu >= 30 && global.submenu <= 33) || global.submenu == 36)
    {
        ...
        draw_set_color(c_white);
        draw_text(xx + 270, yy + 95, string_hash_to_newline(scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_74_0")));
        ...
        draw_sprite(spr_heart, 0, _heartXPos, yy + 130 + (global.submenucoord[30] * 35));
        
        if (global.submenu == 33)
            draw_set_color(c_yellow);
        
        draw_text(_xPos, yy + 120, string_hash_to_newline(scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_86_0")));
        draw_text(_selectXPos, yy + 120, string_hash_to_newline(audvol));
        draw_set_color(c_white);
        draw_text(_xPos, yy + 155, string_hash_to_newline(scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_91_0")));
        draw_text(_xPos, yy + 190, string_hash_to_newline(scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_92_0")));
        draw_text(_selectXPos, yy + 190, string_hash_to_newline(flashoff));
        ...
        {
            draw_text(_xPos, yy + 225, string_hash_to_newline(scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_93_0")));
            draw_text(xx + 430, yy + 225, string_hash_to_newline(fullscreenoff));
            draw_text(_xPos, yy + 260, string_hash_to_newline(scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_94_0")));
            draw_text(xx + 430, yy + 260, string_hash_to_newline(runoff));
            draw_text(_xPos, yy + 295, string_hash_to_newline("Window Size"));
            draw_text(xx + 430, yy + 295, string_hash_to_newline(window_get_width() == 640) ? "x1" : "x2");
            draw_text(_xPos, yy + 330, string_hash_to_newline(scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_95_0")));
            draw_text(_xPos, yy + 365, string_hash_to_newline(scr_84_get_lang_string("obj_darkcontroller_slash_Draw_0_gml_96_0")));
        }
    }
